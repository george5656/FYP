...
public class StockType {
	...
	/**
	 * get the cost associated with this stock type object. note its cost per unit
	 * 
	 * @return String, which is a double in a string format, and is the value in the
	 *         cost variable.
	 */
	...
	/**
	 * gets the quantity associated with this stock type object. note this is meant
	 * for when the stock type is in a dish so know how much the dish needed of this
	 * stockType
	 * 
	 * @return String, which is a double in a string format, and is the value in the
	 *         quantity variable.
	...
	/**
	 * this is not official syntax. it is used by the current stock in its listView.
	...
	/**
	 * not official format. is done this was so that it is displayed the correct way
	 * in the listView. format = "name = ${name}, cost = ${cost}, quantityType =
	 * ${quanityType}, quanity = ${quanity}
	 * 
