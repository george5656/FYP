...
/**
 * 
 * Current object is used to represent an stock iteration when using the stock
 * management system
 * 
 * @author Student
 *
...
public class CurrentStock extends StockType {
	 ...
	 * @param cost              = Double
	 */
	public CurrentStock(Integer id, String storageLocationId, Double quantity, String quantityType, String expiereDate,
	...
	/**
	 * not official syntax but done this was for the listview, need a equals and
	 * proper to string syntax.
	 * 
	 * @return String
	 */
	@Override
	public String toString() {
		return super.toString() + ", id = " + id + ", storage location = " + storageLocationId + ", quantity = "
				+ super.getQuanity() + ", expire date = " + expiereDate;
	}
