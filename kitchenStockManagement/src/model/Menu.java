...
public class Menu {
	...
	/**
	 * not standard format. format = name = ${name} point is so the menu object is
	 * presented as intended in the listview.
	 * 
	 * @Return String
	 */
	@Override
	...
	/**
	 * get the name associated with the menu object. also is the menu pk in the
	 * database.
	 * 
	 * @return String
	 */
	...
	/**
	 * checks if the object already holds the dish. note as each dish is identified
	 * by its pk its only checking the name of the dish, as that is it primary key
	 * 
	 * @param item = String which is the name of the dish, want to know if object
	 *             already has.
	 ...
	 * 
	 * @param place = int, which is the index (place in menu held arrayList<Dish>)
	 *              of the dish to be removed.
	 */
	 ...
	 * 
	 * @return ArrayList<String> = each input in the ArrayList is the output of a
	 *         Dish method getName
	 */
