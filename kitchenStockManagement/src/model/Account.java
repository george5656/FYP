...
/**
 * class to make account object. account object is used to represent an account
 * using the stock mangamnet system
 * 
 * @author Student
 *
 */
public class Account {
	...
	/**
	 * not the standard format. it is a custom one for the accountList page list
	 * view.
	 * 
	 * @return String
	 */
	...
	/**
	 * used for the table view, so can display if account is admin. return value of
	 * isAdmina as a string.
	 * 
