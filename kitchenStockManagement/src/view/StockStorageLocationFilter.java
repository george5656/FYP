...
/**
 * class is meant as a view/page. the point of the class is to be able to get
 * user input, which can then be used to filter storage locations.
 * 
 * @author Student
 *
 */
public class StockStorageLocationFilter extends BasicLayoutFilter {
	 ...
	 * 
	 * @param type = ArrayList<String>, which is all the storage location type
	 *             options.
	 */
...
//false = no, true = yes
	 ...
	 * 
	 * @return Boolean, false = radio button no has been selected, true = radio
	 *         button yes has been selected.
	 */
	 ...
	 * 
	 * @return boolean, true = is empty(no selection), false = item has been
	 *         selected
	 */
