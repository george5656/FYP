...
public class ListPage<E> extends PaneMenu {
	...
	/**
	 * get the label node. the label is hidden by default and meant to be used to
	 * show errors
	 * 
	 * @return Label
	 */
	...
	public void setTableColumns(ArrayList<TableColumn<E, String>> columns) {
		...
		// needs these as without it,when it reload the width may not change and not get
		// triggered.
