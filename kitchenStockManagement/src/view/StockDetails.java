...
/**
 * class is a page/view of the application. class represent a way for the user
 * to input details and see details of stock, so that stock can be added and
 * edited.
 * 
 * @author Student
 *
...
public class StockDetails extends BasicLayoutDetails {
	...
	public StockDetails() {
		...
		labels.getChildren().addAll(txtStockName, txtStorageLocation, txtQuanity, txtQuantityType, txtExpiereDate,
				txtCost);
		userTextInput.getChildren().addAll(tfStockName, cbStorageLocation, tfQuanity, tfQuantityType, dpExpiereDate,
				tfCost);
	...
	/**
	 * changes the buttons on show. it adds the btnFileLoad if it isn't present,
	 * when the page is loaded. needed as page is loaded for the add and edit.
	 */
	...
	/**
	 * changes the buttons on show. it removes the btnFileLoad if it is present,
	 * when the page is loaded. needed as page is loaded for the add and edit.
	 */
	...
	/**
	 * reset the dataPicker set value. sets the value to null
	 */
