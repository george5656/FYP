...
/**
 * class is a page that allows the input of filter values to be applied. the
 * filters categories are designed to be for the CurrentStock objects.
 * 
 * @author Student
 *
 */
public class StockFilter extends BasicLayoutFilter {
	...
	public StockFilter() {
		...
		/*
		 * tfMinQuanity.setFont(new Font(30)); tfMaxQuanity.setFont(new Font(30));
		 * tfAboveCost.setFont(new Font(30)); tfBelowCost.setFont(new Font(30));
		 */
	...
	/**
	 * resets all the user input on this page not counting the data picker as they
	 * passed in data.
	 */
