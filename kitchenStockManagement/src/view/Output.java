...
/**
 * class is meant to represent a page shown to the user. page contains a
 * selection of buttons, which determine how the list are outputed.
 * 
 * @author Student
 *
 */
public class Output extends PaneMenu {
	...
	public Output() {
		...
		layout.getChildren().addAll(txtTitle, btnMenu, btnShoppingList, btnSave, btnBackToMenuDetails,
				btnBackToMenuList);
