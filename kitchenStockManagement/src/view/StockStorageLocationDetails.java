...
/**
 * class is a page/view in the application.
 * point of class is to allow the user to input and see 
 * storage location details, so that they can be used for 
...
/**
 * clear page of all user input and reset all the radio button to be not selected.
 */
	public void reset() {
		tfName.clear();
		tfType.clear();
	 ...
	 * @param isAvaible = Boolean, populate the is available area. 
	 * if true, yes radio button selected, if false, no (as in the radio button that text says no) radio 
	 * button selected
	 */
