...
/**
 * class is meant to be a page in application. the point of the page is to show
 * the user info and get the user info. the input categories are all based
 * around dish details, as it is is aimed at editing and creating dishes.
 * 
 * @author Student
 *
 */
public class DishDetailsPage extends PaneMenu {
	 ...
	 * 
	 * @param ingredents = ObservableList<StockType>, which values are shown in the
	 *                   tableView.
	 */
	...
	/**
	 * get the item that is selected in the table view. note gets the value held in
	 * the underlining data structure
	 * 
	 * @return StockType
	 */
	 ...
	 * @param quanityType = String goes in to the unit /quantity type user input
	 *                    area
	...
	/**
	 * simply used to identify when the table view changes size and adjust all the
	 * columns accoridningly
	 * 
	 * @author Student
	 *
	 */
	private class EHTableColumSize implements ChangeListener<Number> {
		...
		public void changed(ObservableValue<? extends Number> observable, Number oldValue, Number newValue) {
			tvIngredients.getColumns()
					.forEach(x -> x.setPrefWidth(tvIngredients.getWidth() / tvIngredients.getColumns().size()));
